...
1. Write the plan to a temp file with this prompt:
   ...
   You have read-only access to the full repo. Read `.Codex/codex-guide.md` FIRST for efficient navigation, then read `AGENTS.md` for architecture boundary rules.
   ...
   ## Review Instructions
   1. Check the plan against architecture boundary rules in AGENTS.md (engine vs flows vs underwriting vs banking-core)

...
export const uploads = pgTable(
  ...
  (table) => [
    index("idx_uploads_driver_status").on(table.driverId, table.status),
  ],
);
...
export const weeklyData = pgTable(
  "weekly_data",
  {
    ...
    platformCommissionPct: decimal("platform_commission_pct", {
      precision: 5,
      scale: 2,
    }),
    ...
    waitTimeEarnings: decimal("wait_time_earnings", {
      precision: 10,
      scale: 2,
    }),
  ...
  (table) => [
    unique("uq_weekly_data_driver_platform_week").on(
      table.driverId,
      table.platform,
      table.weekStart,
    ),
...
export const populationStats = pgTable(
  "population_stats",
  {
    ...
    p10: decimal("p10", { precision: 10, scale: 2 }),
    p25: decimal("p25", { precision: 10, scale: 2 }),
    p50: decimal("p50", { precision: 10, scale: 2 }),
    p75: decimal("p75", { precision: 10, scale: 2 }),
    p90: decimal("p90", { precision: 10, scale: 2 }),
    mean: decimal("mean", { precision: 10, scale: 2 }),
    updatedAt: timestamp("updated_at", { withTimezone: true })
      .notNull()
      .defaultNow(),
  },
  (table) => [
    unique("uq_population_stats").on(
      table.city,
      table.platform,
      table.metricName,
      table.period,
